    ...
    return class Thermostat extends OtgwService {
      constructor (otgwAccessory, params = {}) {
        ...
        this.addCharacteristicDelegate({
          ...
          try {
            if (fromHomeKit) {
              ...
              this.values.newOverride == null && value !== this.values.override
            ) {
        ...
        this.addCharacteristicDelegate({
          ...
          try {
            if (fromHomeKit) {
              this.setTemperature(value ? 0 : this.values.targetTemperature)
            }
          } catch (error) { this.warn(error) }
        })
        this.addCharacteristicDelegate({
