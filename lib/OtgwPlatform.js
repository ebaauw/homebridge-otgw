...
module.exports = class OtgwPlatform extends homebridgeLib.Platform {
  ...
  async heartbeat (beat) {
    if (this.client == null) {
      ...
      if (this.loggingActive > 0) {
        this.loggingActive--
      } else if (!this.loggingReEnabling) {
        this.loggingReEnabling = true
  ...
  get logLevel () {
    if (this.otgwAccessories == null || this.otgwAccessories.Thermostat == null) {
      return 2
    }
    return this.otgwAccessories.Thermostat.logLevel
  }
}
